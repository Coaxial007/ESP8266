...
const PROGMEM char* MQTT_CLIENT_ID = "ESP8266_power";
const PROGMEM char* MQTT_SERVER_IP = "192.168.xx.xx";
const PROGMEM uint16_t MQTT_SERVER_PORT = 1883;
const PROGMEM char* MQTT_USER = "xxxxx";
const PROGMEM char* MQTT_PASSWORD = "xxxxx";

#define SWITCH_TOPIC_1     "power/led"
#define RELAY_TOPIC_1     "power/relay1"
#define RELAY_TOPIC_2     "power/relay2"
#define RELAY_TOPIC_3     "power/relay3"
...
#define OTAUSER         "xxxxx"    // Set OTA user
